...
export PEER_ORG1_CA=${PWD}/organizations/peerOrganizations/org1.brahma.com/tlsca/tlsca.org1.brahma.com-cert.pem
export PEER_ORG2_CA=${PWD}/organizations/peerOrganizations/org2.brahma.com/tlsca/tlsca.org2.brahma.com-cert.pem
export PEER_ORG3_CA=${PWD}/organizations/peerOrganizations/org3.brahma.com/tlsca/tlsca.org3.brahma.com-cert.pem
