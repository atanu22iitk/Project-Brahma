...
async function main(userID, channelName, contractName, functionName, orgName, key) {
    try {
...
// pass the parameters in following sequence userID, channelName, contractName, functionName, orgName, key
// key is in the format userid_timestamp
